...
public class FlameCastPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = HallownestMod.makeID("FlameCastPower");
    ...
    public FlameCastPower(final AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new FlameCastPower(owner);
    }
}
