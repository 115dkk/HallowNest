...
public class powerInfection extends AbstractPower implements CloneablePowerInterface{
        public AbstractCreature source;
        public static final Logger logger = LogManager.getLogger(HallownestMod.class.getName());

        public static final String POWER_ID = HallownestMod.makeID("powerInfection");
        ...
        public powerInfection(final AbstractCreature owner, int amount) {
            this.name = NAME;
            this.ID = POWER_ID;
        ...
        { // At the end of your turn
            ...
            */
            AbstractDungeon.actionManager.addToBottom(new DamageAction(this.owner, new DamageInfo(this.owner, InfDamage, DamageInfo.DamageType.THORNS)));
        ...
        public AbstractPower makeCopy() {
            return new powerInfection(owner, amount);
        }
}
