...
public class powerPlatedThorns extends AbstractPower {

    public static final String POWER_ID = HallownestMod.makeID("powerPlatedThorns");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("PlatedSpikespower84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("PlatedSpikespower32.png"));

    public powerPlatedThorns(AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
