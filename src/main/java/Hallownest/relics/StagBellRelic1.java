...
public class StagBellRelic1 extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = HallownestMod.makeID("StagBellRelic1");

    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("StagBell1.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("StagBell1.png"));
    private int CardDraw = 6;
    private boolean isPlayerTurn = false; // We should make sure the relic is only activateable during our turn, not the enemies'.

    public StagBellRelic1(){
        this(1);
    }


    public StagBellRelic1(int charge) {
