...
public class WatcherSealRelic extends CustomRelic {

    public static final String ID = HallownestMod.makeID("WatcherSealRelic");

    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("WatcherSealRelic.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("WatcherSealRelic.png"));

    private boolean usedThisCombat = false;

    public WatcherSealRelic() {
