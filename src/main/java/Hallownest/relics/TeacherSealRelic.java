...
public class TeacherSealRelic extends CustomRelic {

    public static final String ID = HallownestMod.makeID("TeacherSealRelic");

    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("TeacherSealRelic.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("TeacherSealRelic.png"));

    private boolean usedThisCombat = false;

    public TeacherSealRelic() {
