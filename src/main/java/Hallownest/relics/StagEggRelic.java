...
public class StagEggRelic extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = HallownestMod.makeID("StagEggRelic");
    ...
    public StagEggRelic(int charge) {
