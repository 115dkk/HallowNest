...
public class CorniferEvent2 extends AbstractImageEvent {

    public static final String ID = HallownestMod.makeID("CorniferEvent2");
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);

    private static final String NAME = eventStrings.NAME;
    private static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    private static final String[] OPTIONS = eventStrings.OPTIONS;
    public static final String IMG = makeEventPath("CotCorniferA.png");
    public static final String IMG2 = makeEventPath("CotCorniferB.png");
//
    ...
    private int mapcost = 80;



    private int screenNum = 0;

    public CorniferEvent2() {
    ...
    public void onEnterRoom() {
        if (Settings.AMBIANCE_ON) {
            CardCrawlGame.sound.playV(SoundEffects.EvGpCorniferHum.getKey(), 1.2F);
        }
                ...
                switch (buttonPressed) {
                    case 0: //Encounter a normal enemy
                        ...
                        if (AbstractDungeon.player.gold >= mapcost) {
                            ...
                            this.imageEventText.setDialogOption(OPTIONS[2] + mapcost + OPTIONS[3], CardLibrary.getCopy(skillCityofTearsMap.ID));
                        } else {
            ...
            case END_SCREEN:
                switch (buttonPressed) {
                    case 0: //upgrade 2 random attacks
                        ...
                        AbstractDungeon.effectList.add(new ShowCardAndObtainEffect(new skillCityofTearsMap(), (float)Settings.WIDTH / 2.0F, (float)Settings.HEIGHT / 2.0F));
