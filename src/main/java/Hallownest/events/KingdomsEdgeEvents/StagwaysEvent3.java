...
import Hallownest.relics.StagEggRelic;
...
public class StagwaysEvent3 extends AbstractImageEvent {


    public static final String ID = HallownestMod.makeID("StagwaysEvent3");
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);

    private static final String NAME = eventStrings.NAME;
    private static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    private static final String[] OPTIONS = eventStrings.OPTIONS;
    public static final String IMG = makeEventPath("KEStagwaysA.png");
    public static final String IMG2 = makeEventPath("KEStagwaysB.png");
    public static final String IMG3 = makeEventPath("KEStagwaysC.png");
    public static final String IMG4 = makeEventPath("KEStagwaysC.png");

    private static int goldcost = 60;
    private int MaxHPgain = 7 ;
    public int stations = 0;
    private int Upgrading = 0;
    ...
    public StagwaysEvent3() {
        ...
        if (AbstractDungeon.player.gold >= goldcost) {
            ...
            this.imageEventText.setDialogOption(OPTIONS[7] + goldcost + OPTIONS[8], true);
        }
                ...
                switch (i) {
                    case 0: // Proceed
                        ...
                        if (AbstractDungeon.player.hasRelic(StagBellStandRelic.ID)) {
                            ...
                            screenNum = 5;
                            //this.imageEventText.setDialogOption(OPTIONS[5], RelicLibrary.getRelic(StagEggRelic.ID));
                            Upgrading = 2;
                        } else if (AbstractDungeon.player.hasRelic(StagBellRelic1.ID)) {
            ...
            case 5: // Stagnest A
                switch (i) {
                    case 0: // On to Queen Garden
                        ...
                        this.imageEventText.setDialogOption(OPTIONS[6], RelicLibrary.getRelic(StagEggRelic.ID));
                        this.imageEventText.setDialogOption(OPTIONS[0]);
                        screenNum = 6;
            ...
            case 6: // Stagnest A
                switch (i) {
                    case 0: // On to Queen Garden
                        ...
                        if (AbstractDungeon.player.hasRelic(StagBellStandRelic.ID)){
                            AbstractDungeon.player.loseRelic(StagBellStandRelic.ID);
                        }
                        if (!AbstractDungeon.player.hasRelic(StagEggRelic.ID)){
                            AbstractDungeon.getCurrRoom().spawnRelicAndObtain(Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F, new StagEggRelic());
                        } else {
                            AbstractDungeon.getCurrRoom().spawnRelicAndObtain(Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F, new Circlet());
                        }
