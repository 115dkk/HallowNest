package Hallownest.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import Hallownest.cards.AbstractDefaultCard;

import static Hallownest.HallownestMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "Hallownest:" (or, your ID) before the name.
    }
