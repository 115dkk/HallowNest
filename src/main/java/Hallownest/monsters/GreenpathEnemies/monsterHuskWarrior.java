...
public class monsterHuskWarrior extends AbstractMonster {
    ...
    public static final String ID = HallownestMod.makeID("monsterHuskWarrior");
	...
	*/
        super(monsterHuskWarrior.NAME, ID, 32, 0.0F, 0.0F, 175.0F, 200.0F, null, xOffset, 0.0F);
        ...
        loadAnimation(
                //loads the animation
                ("HallownestResources/images/monsters/Greenpath/huskwarrior/HuskWarrior.atlas"),
                ("HallownestResources/images/monsters/Greenpath/huskwarrior/HuskWarrior.json"), 0.9F);
