...
import Hallownest.actions.empowerLouseAction;
...
public class eliteMossKnight extends AbstractMonster {
    ...
    */
    public static final String ID = HallownestMod.makeID("eliteMossKnight");
    ...
    //you will need to assign both values whenever you spawn or setup the encounter for the monster. Most likely in your main mod file. thedefault.java
    {
        ...
        loadAnimation(
                ...
                ("HallownestResources/images/monsters/Greenpath/mossknight/MossKnight.atlas"),
                ("HallownestResources/images/monsters/Greenpath/mossknight/MossKnight.json"), 0.8F); // scale float is actually inverted because of course it is. 0.8 is bigger, 1.2 is smaller.
    ...
    public void takeTurn() {
        ...
        */
        ...
        switch (this.nextMove) {   //0 Swing- att
            case 0: //Combo
            ...
            case 1: //Spit
                ...
                AbstractDungeon.actionManager.addToBottom(new SpawnMonsterAction((new monsterBaldur(-350.0F)), true));
