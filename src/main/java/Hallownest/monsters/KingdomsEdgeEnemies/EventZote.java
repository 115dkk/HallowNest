...
public class EventZote extends AbstractMonster {
    ...
    */
    public static final String ID = HallownestMod.makeID("Zote");
    ...
    //you will need to assign both values whenever you spawn or setup the encounter for the monster. Most likely in your main mod file. thedefault.java
    {
        ...
        loadAnimation(
                ...
                ("HallownestResources/images/monsters/KingdomsEdge/zote/Zote.atlas"),
                ("HallownestResources/images/monsters/KingdomsEdge/zote/Zote.json"), 1.4F);; // scale float is actually inverted because of course it is. 0.8 is bigger, 1.2 is smaller.
        ...
        */
        ...
        {   //0 Swing- att
            case 0: //Combo
                ...
                this.hb_x = this.hb_x -75.0f;
                this.hb.update();

                break;
            case 1: //Spit
                AbstractDungeon.actionManager.addToBottom(new ChangeStateAction(this, "TOOLATE"));
                AbstractDungeon.actionManager.addToBottom(new DamageAction(p, new DamageInfo(this,AbstractDungeon.player.currentHealth/10), AbstractGameAction.AttackEffect.BLUNT_LIGHT));

                break;
            case 2: //Nothing
                AbstractDungeon.actionManager.addToBottom(new SFXVAction(SoundEffects.EvGpZote1.getKey(), 1.8F));
