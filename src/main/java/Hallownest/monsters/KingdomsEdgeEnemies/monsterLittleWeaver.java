...
public class monsterLittleWeaver extends AbstractMonster {
    ...
    public static final String ID = HallownestMod.makeID("LittleWeaver");
	...
	*/
        ...
        loadAnimation(
                //loads the animation
                ("HallownestResources/images/monsters/KingdomsEdge/littleweaver/LittleWeaver.atlas"),
                ("HallownestResources/images/monsters/KingdomsEdge/littleweaver/LittleWeaver.json"), 1.1F);
    ...
    public void takeTurn()
    {
        ...
        {   //0 Swing- att
            ...
            case 1: //calls the assigned block value
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new powerExposure(AbstractDungeon.player,this,1),1));
                break;
            case 2: //Webbing
