...
public class BossRadiance extends AbstractMonster {
    ...
    public static final String ID = HallownestMod.makeID("Radiance");
	...
	*/
        ...
        loadAnimation(
                //loads the animation
                ("HallownestResources/images/monsters/KingdomsEdge/radiance/Radiance.atlas"),
                ("HallownestResources/images/monsters/KingdomsEdge/radiance/Radiance.json"), 1.5F);
    ...
    public void usePreBattleAction() {
        ...
        CardCrawlGame.music.playTempBgmInstantly("RadianceBGM", true);
    ...
    public void takeTurn()
    {
        ...
        switch (this.nextMove)
        {
            ...
            case 7: //infscream
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyInfectionAction(p, this, this.infectAmt));
                //AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, this, new powerInfection(p, this, this.infectAmt),this.infectAmt));
