...
public class eliteStalkingDevout extends AbstractMonster {
    ...
    public static final String ID = HallownestMod.makeID("StalkingDevout");
    ...
    private int maxHP = 190;
    private int minHP = 180;
	...
	*/
        ...
        loadAnimation(
                //loads the animation
                ("HallownestResources/images/monsters/KingdomsEdge/stalkingdevout/StalkingDevout.atlas"),
                ("HallownestResources/images/monsters/KingdomsEdge/stalkingdevout/StalkingDevout.json"), 1.0F);
