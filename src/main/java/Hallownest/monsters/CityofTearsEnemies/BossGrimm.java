...
import Hallownest.powers.FlameCastPower;
...
public class BossGrimm extends AbstractMonster {

    public static final String ID = HallownestMod.makeID("BossGrimm");
    ...
    private int fbatDmg = 9;
    private int fbats = 2;
    private int lingerDefVal = 75;
    ...
    private int tpDamage = 9;
    private int lingerBlockTurns = 3;
    private int flameVal = 7;
	...
	*/
        super(NAME, ID, 375, 0, 0, 300.0F, 475.0F, null, x, y);
        ...
        loadAnimation(
                //loads the animation
               ("HallownestResources/images/monsters/CityofTears/Grimm/NKGrimm.atlas"),
                ("HallownestResources/images/monsters/CityofTears/Grimm/NKGrimm.json"), 1.10F);
    ...
    public void usePreBattleAction() {
        ...
        AbstractDungeon.getCurrRoom().playBgmInstantly("GrimmBGM");
