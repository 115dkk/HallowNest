...
public class monsterHuskSentry extends AbstractMonster {
    ...
    public static final String ID = HallownestMod.makeID("HuskSentry");
	...
	*/
        super(monsterHuskSentry.NAME, ID, 65, 0.0F, 0.0F, 200.0F, 400.0F, null, xOffset, 50.0F);
        ...
        loadAnimation(
                //loads the animation
                ("HallownestResources/images/monsters/CityofTears/husksentry/HuskSentry.atlas"),
                ("HallownestResources/images/monsters/CityofTears/husksentry/HuskSentry.json"), 0.9F);
    ...
    public void takeTurn()
    {
        ...
        {   //0 Swing- att
            case 0: //BRava
                ...
                this.updateHitbox(0.0F, 0.0F, 200.0F, 400.0F);
            ...
            case 1: //Intangible/fly
                ...
                this.updateHitbox(this.hb_x+75, this.hb_y+50, 200.0F, 450.0F);
                break;
            case 2: //slash
    ...
    {   /*
        ...
        if ((i < 65) && (AbstractDungeon.getMonsters().monsters.size() == 1 )){
