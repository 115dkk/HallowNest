...
public class InfectedProjectileEffect extends AbstractGameEffect {
    ...
    //oh look it's the slime effects exactly but color swapped

    private ArrayList<Vector2> previousPos = new ArrayList();

    public InfectedProjectileEffect(float srcX, float srcY, float duration) {
        this(srcX,srcY,AbstractDungeon.player.hb.cX, AbstractDungeon.player.hb.cY, 1.0f,false,duration,false,false);
    }

    public InfectedProjectileEffect(float srcX, float srcY, float destX, float destY, float scale, boolean rain, float duration) {
        this(srcX,srcY,destX,destY,scale,rain,duration,false,false);
    }


    public InfectedProjectileEffect(float srcX, float srcY, float destX, float destY, float scale, boolean rain, float duration, boolean mute, boolean bigHeight) {
        if (img == null) {
            img = ImageMaster.loadImage(HallownestMod.makeEffectPath("InfBallWhite.png"));
        }
        ...
        this.color = new Color(1.0f, 0.635f, 0f, 1.0f);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.setColor(new Color(1.0f, 0.635f, 0f, 0.95f));
