...
public class InfectedParticleEffect extends com.megacrit.cardcrawl.vfx.AbstractGameEffect {
    ...
    public InfectedParticleEffect(float x, float y, Color deathColor) {
